                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                            $button = $_POST['buton'] ?? ''; // Menambahkan nilai default jika $_POST['buton'] kosong
                        ...
                        ?>
                        <input type="text" class="form-control mb-3 display" name="display" id="display" readonly value="<?php echo htmlspecialchars( $current, ENT_QUOTES); ?>" >
